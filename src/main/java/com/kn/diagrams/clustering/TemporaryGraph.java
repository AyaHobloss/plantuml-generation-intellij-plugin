 ...
 */
package com.kn.diagrams.clustering;
...
public final class TemporaryGraph implements Graph {
    ...
    public static final class Builder {
        ...
        public static Graph fromGdl(String gdl, Orientation orientation) {
            ...
            return new TemporaryGraph(adjacencyList, nodeProperties, relationshipProperty, hasRelationshipProperty);
        }
